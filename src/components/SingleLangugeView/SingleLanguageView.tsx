...
function DeleteButton(props: {
    ...
    return (
        <>
            ...
            {
                isModalOpen ? (<Modal title="Delete" open={true} onOk={handleOk} onCancel={handleCancel}
    ...
    function makeColumns() {
        let keyData = [
            ...
            },
            {
                ...
                key: "key",
                render: (text: string) => {
                    return <HighlightText text={text} highlightTexts={["%@", searchText]}/>
                }
                        ...
                        <Space size="middle">
                            ...
                            <ModalButton
                                ...
                                onModalChanged={(languageCode, oldKey, newKey, value) => {
                                    ...
                                    if (!isChangedKey && !isChangedValue) {
                                        return;
                                    }
